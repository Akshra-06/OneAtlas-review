    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <Button asChild>
            <Link href="/interactions/new" className="gap-2">
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-dashed bg-background p-10 text-center shadow-sm">
          <p className="text-base font-semibold">
            No interaction yet. Create your first one 
          </p>
          <p className="mt-1 text-sm text-muted-foreground">
            No interaction yet. Create your first one to get started.
          </p>
